...
##### ...is a set of tools to predefine actions in your rocket.

##### RO/RP-1 only:		 A simple automated guidance computer for those ballistic shots (downrange contracts).
...
#####					 RCS can be activated at a set time after launch or prior to reaching Apside.
##### RO/RP-1 and stock: Decoupler can be activated at a set time after launch or prior to reaching Apside.
