...
##### ...is a set of five tools to predefine staging actions in your rocket.
...
##### Set desired inclination and the Ascent Guidance will steer your rocket into that plane.

##### On-Screen appearing messages for all events can be turned on / off (in VAB and Flight).


##### A picture says more than a hundredandfourteen words, so check out the awesome flowchart in the pdf provided.
