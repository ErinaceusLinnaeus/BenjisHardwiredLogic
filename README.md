...
##### ...is a set of four tools to predefine staging actions in your rocket.
...
##### A picture says more than a hundred words, so check out the awesome flowchart in the pdf provided.
